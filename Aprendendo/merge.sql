/*
O comando MERGE pode comparar uma Tabela, View ou Subconsulta origem com uma Tabela destino
e atualizar ou deletar linhas correspondentes existentes na tabela destino ou se não existirem lihas correspondentes, inserir uma nova linha na tabela destino.
*/
-- Comando MERGE
...
WHEN MATCHED THEN --Quando existir correpondente
   UPDATE SET 
...
WHEN NOT MATCHED THEN -- Quando não existir correpondente 

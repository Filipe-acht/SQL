...
-- Criando Materialized View log -> para registrar as alterações na tabela 
...
-- Nested Materialized Views -> é quando o select da view materializada referencia outra view materializada
